    ...
    return SizedBox(
      child: InkWell(
        onTap: (){
          ...
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context)=> MovieDetailsPage(title: '${widget.acacia['title']}', poster: '${widget.acacia['poster']}', description: '${widget.acacia['description']}', clip: '${widget.acacia['clip']}', genre: '${widget.acacia['genre']}', duration:'${widget.acacia['duration']}')));
        },
        child: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  Text("${widget.acacia['title']}", style: const TextStyle(color: Colors.white), textScaleFactor: 2,),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("${widget.acacia['rating'].toString()}/10", style: const TextStyle(color: Colors.white), textScaleFactor: 1.5,),
